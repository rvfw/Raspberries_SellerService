package com.example.raspberriesSellerService.config;
...
public class KafkaConfig {
    ...
    public KafkaConfig(SellerRepository sellerRepository) {
    ...
    public ConsumerFactory<Long, Object> consumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "company-service-group");
